## Upstream history (`magic-wormhole.rs`)

The entries below were authored by the magic-wormhole.rs maintainers prior to the Blackhole fork. They are preserved here as a record of the engineering history that this codebase inherits.
