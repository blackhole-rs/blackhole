...
The Blackhole project has strict rules for AI usage:
...
- **Bad AI drivers will be denounced.** People who produce bad
  contributions that are clearly AI (slop) will be added to our public
  denouncement list via [`vouch`](https://github.com/mitchellh/vouch).
  ...
  We love to help junior developers learn and grow, but if you're
  interested in that then don't use AI, and we'll help you. We're sorry
  that bad AI drivers have ruined this for you.

These rules apply only to outside contributions to Blackhole. Maintainers
...
Please remember that Blackhole is maintained by humans.
...
Blackhole is written with plenty of AI assistance, and many maintainers
...
This section exists to be transparent about the project's usage of AI for
people who may disagree with this policy, and to address the misconception
that this policy is anti-AI in nature.

## Acknowledgement

This policy is adapted from the [Ghostty AI Usage Policy](https://github.com/ghostty-org/ghostty/blob/main/AI_POLICY.md) by Mitchell Hashimoto and the Ghostty contributors. Thanks for making the case clearly so we didn't have to.
